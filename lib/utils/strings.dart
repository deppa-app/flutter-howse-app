class Strings {
  //splash screen
  static String appName = 'Howse';
  static String version = ' Versión 0.1.0';

  //set_lenguage screen
  static String lenguageBtn1 = 'English';
...
// sign_in_screen
  ...
  //activate_bluetooth
  static String informativeText =
      ' Antes de realizar la coneccion al dispositivo e-LUFT';
  static String informativeText3 = ' encerder bluetooth';
  ...
  static String textMessage = 'Bajo riesgo de contagio';
  static String temperature = 'Temperatura';
  ...
  static String reintentos = 'Quedan ';
  static String reintentos2 = ' intentos antes de bloquear su sesión';
  static String recupacionContrasena =
      'Se enviara su contraseña de recuperación a su email registrado';
  ...
  static String message = 'Ingrese su email para recuperar su contraseña';

  //adminitrator screen
  static String alertMessage = 'Mensajes de alerta: ';
  static String message1 = 'Mensaje de alerta normal: ';
  static String message2 = 'Mensaje de alerta media: ';
  static String message3 = 'Mensaje de alerta alta: ';
  static String message4 = 'Mensaje de alerta emergencia: ';
  static String message5 = 'Nombre del dispositivo: ';
  static String message6 = 'Sala: ';
  static String message7 = 'Establecimiento: ';
  ...
  static String demoCity = 'Ring Road, Canada';
  ...
  static String youHaveSuccessfullyPlaced = 'You Have Successfully Placed';
  static String shippingAddress = 'Shipping Address';
  static String placeOrder = 'Place Order';

  //order success screen
  static String thanksYourOrder = 'Thanks Your Order';
  ...
  //myCoupon screen
  static String myCoupon = 'Ver Conexión';

  //myCoupon screen
  static String myWallet = 'Perfil';

  //  my wallet screen
  static String amount = 'Tutorial';
  static String totalDeposit = 'Nosotros';
  ...
  static String howtodo = 'Tutorial';
  ...
  static String demoAddress = 'Newyork City 1425, CA';
